...
public class GlobeSortClient {
    ...
    public void run(Integer[] values) throws Exception {
        ...
        //double pingStartTime = System.currentTimeMillis();//pingStartTime
        ...
        //double pingEndTime = System.currentTimeMillis();//pingEndTime
        ...
        long sortStartTime = System.nanoTime();//t1
        IntArray response = serverStub.sortIntegers(request);
        long sortEndTime = System.nanoTime();//t4

        long appTime = sortEndTime - sortStartTime;
        double appTimeSeconds = (double)appTime / 1000000000.0;

        double oneWayTimeSeconds = (appTimeSeconds - response.getTime())/2;
